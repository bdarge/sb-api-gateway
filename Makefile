...
proto:
	...
	--go_opt=Mpb/transactionItem.proto=github.com/bdarge/api-gateway/out/transactionItem \
	...
	--go-grpc_opt=Mpb/transactionItem.proto=github.com/bdarge/api-gateway/out/transactionItem \
